...
fn snapshot_ai_popup_not_configured() {
    let mut state = AiState::new_with_config(true, false, "Anthropic".to_string());
    state.visible = true;
...
fn snapshot_ai_popup_bedrock_provider() {
    let mut state = AiState::new_with_config(true, true, "Bedrock".to_string());
    state.visible = true;
...
fn snapshot_ai_popup_openai_provider() {
    let mut state = AiState::new_with_config(true, true, "OpenAI".to_string());
    state.visible = true;
